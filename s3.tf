...
resource "aws_s3_bucket_notification" "s3-sns-notification" {
  count = var.create_s3_sns_notification ? 1 : 0
  bucket = var.s3_bucket_id
  topic {
...
resource "aws_s3_bucket_notification" "s3-lambda-notification" {
  count = var.create_s3_lambda_notification ?  1 : 0
  bucket = var.s3_bucket_id
  lambda_function {
